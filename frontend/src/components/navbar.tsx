...
const NavBar = () => {
  ...
  return (
    <nav className="z-50 sticky top-0 bg-background/80 border-b backdrop-blur-md shadow-sm">
              ...
              <>
                <Popover>
                  <PopoverTrigger asChild>
                    <button className="flex item-center gap-2 hover:opacity-80 transition-opacity">
                      <Avatar className="h-9 w-9 ring-2 ring-offset-2 ring-offset-background ring-blue-500/20 cursor-pointer hover:ring-blue-500/40 transition-all">
                        ...
                        <AvatarFallback className="bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-white">
                  ...
                  <PopoverContent className="w-56 p-2" align="end">
                    <div className="px-3 py-2 mb2 border-b">
                      <p className="text-sm font-semibold">{user ? user.name : "Your name"}</p>
      ...
      >
        <div className="p-3 space-y-1 bg-background/95 backdrop-blur-md">
          {/* isAuth or User */}
